 ...
 *   - resolving the backend base URL (VITE_API_BASE_URL, falling back to the
 *     Vite dev proxy via "/api"),
 ...
 *
 * The authentication service (`services/auth.js`) owns the session shape and
 * re-exports the token helpers from here, so there is exactly one place that
